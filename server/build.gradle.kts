...
//    > Failed to transform slf4j-api-1.7.30.jar (org.slf4j:slf4j-api:1.7.30) to match attributes {artifactType=jar, javaModule=true, org.gradle.category=library, org.gradle.libraryelements=jar, org.gradle.status=release, org.gradle.usage=java-runtime}.
//    > Execution failed for ExtraJavaModuleInfoTransform: /Users/mattpeterson/.gradle/caches/modules-2/files-2.1/org.slf4j/slf4j-api/1.7.30/b5a4b6d16ab13e34a88fae84c35cd5d68cac922c/slf4j-api-1.7.30.jar.
