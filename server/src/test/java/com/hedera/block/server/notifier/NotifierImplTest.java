...
public class NotifierImplTest {
    ...
    //        assertFalse(notifier.isSubscribed(concreteObserver1), "Expected the notifier to have unsubscribed
    // observer1");
    //
    //        notifier.unsubscribe(concreteObserver2);
    //        assertFalse(notifier.isSubscribed(concreteObserver2), "Expected the notifier to have unsubscribed
    // observer2");
    //
    //        notifier.unsubscribe(concreteObserver3);
    //        assertFalse(notifier.isSubscribed(concreteObserver3), "Expected the notifier to have unsubscribed
    // observer3");
    //    }
    //
    //    @Test
