...
public class NotifierInjectionModuleTest {
    ...
    @Test
    void testProvidesNotifierBuilder() throws IOException {

        BlockNodeContext blockNodeContext = TestConfigUtil.getTestBlockNodeContext();

        // Call the method under test
        Notifier providesNotifier =
                NotifierInjectionModule.providesNotifier(
                        streamMediator, blockNodeContext, serviceStatus);

        assertNotNull(providesNotifier);
    }
}
