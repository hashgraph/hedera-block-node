...
public class ConsumerStreamResponseObserverTest {
    ...
    @Mock private Flow.Subscriber<? super SubscribeStreamResponse> responseStreamObserver;
    ...
    //                testClock, streamMediator, responseStreamObserver, testContext);
    //
    //        verify(responseStreamObserver, timeout(testTimeout).times(1)).onCloseHandler(any());
