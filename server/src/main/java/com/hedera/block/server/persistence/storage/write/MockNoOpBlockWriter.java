...
public class MockNoOpBlockWriter implements BlockWriter<BlockItem> {

    private final MetricsService metricsService;

    public MockNoOpBlockWriter(BlockNodeContext blockNodeContext) {
        this.metricsService = blockNodeContext.metricsService();
        System.getLogger(getClass().getName()).log(INFO, "Using " + getClass().getSimpleName());
    }

    @Override
    public Optional<BlockItem> write(@NonNull BlockItem blockItem) throws IOException {
